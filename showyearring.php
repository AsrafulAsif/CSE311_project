...
$sql="SELECT jewellery_id,jewellery_name,jewellery_image,jewellery_type,jewellery_info,buy_price,borrow_price FROM jewellery WHERE jewellery_name='yearring'";
...
if($result=mysqli_query($link,$sql))
{
	...
	while($row=mysqli_fetch_array($result))
	{
        ...
        echo"<td>"."<h3>Borrow Price:</h3>"."<br>".$row['borrow_price']."/per day"."</td>";
        echo"<td>"."<a href='buy.php?jid=$row[jewellery_id]&cid=$_SESSION[cusid]'><h4>Buy</h4></a>"."</td>";
        echo"<td>"."<a href='borrow.php?jid1=$row[jewellery_id]&cid1=$_SESSION[cusid]'><h4>Borrow</h4></a>"."</td>";
